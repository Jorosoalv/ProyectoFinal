...
int main()
{
	...
	Model rampa("resources/objects/rampaPinguino/rampa.obj"); // letreros de animaciones
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Huevo
		//-------------------------------------------------------------------------------------------------------
		//model = glm::translate(glm::mat4(1.0f), glm::vec3(-2.0f, 0, 25.0f));
